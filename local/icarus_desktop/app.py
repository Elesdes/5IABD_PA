...
class LoginPage:
    def __init__(self, master):
        ...
        self.hide_image = None
        self.show_image = None
        self.password_icon_label = None
        self.password_line = None
        self.password_entry = None
        self.password_label = None
        self.signup_button_label = None
        self.sign_label = None
        self.login = None
        self.lgn_button_label = None
        self.username_icon_label = None
        self.username_line = None
        self.username_entry = None
        self.username_label = None
        self.sign_in_label = None
        self.sign_in_image_label = None
        self.side_image_label = None
        self.heading = None
        self.lgn_frame = None
        self.bg_panel = None
    ...
    def login_page(self):
        ...
        self.heading = Label(self.lgn_frame, text="WELCOME", font=('yu gothic ui', 25, "bold"), bg="#040405",
                             fg='white',
                             bd=5,
                             relief=FLAT)
